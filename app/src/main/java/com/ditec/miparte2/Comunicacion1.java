...
public  class  Comunicacion1	extends AppCompatActivity { EditText  edtnombre;
    ...
    public  void  Verificar(View view)  {
        Intent  intent  =  new Intent(this,  Comunicacion2.class); intent.putExtra("nombre",  edtnombre.getText().toString());
...
// startActivity(intent);
    ...
    protected  void  onActivityResult(int  requestCode,
        ...
        if  (requestCode  ==  1234  &&  resultCode  ==  RESULT_OK)  { String  res  =  data.getExtras().getString("resultado"); if  (res.equals("aceptado"))
            miresultado.setText("Esperamos  que  trabajar  con  nosotros  sea  de  su  agrado"); else
