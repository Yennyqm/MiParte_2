...
public class Multimedia3 extends AppCompatActivity implements SurfaceHolder.Callback, MediaPlayer.OnPreparedListener, MediaController.MediaPlayerControl {
    ...
    public void surfaceCreated(@NonNull SurfaceHolder surfaceHolder) {
        if(mediaPlayer==null) {
            ...
            {
                construirMediaController(); mediaController.setMediaPlayer(this); mediaController.setAnchorView(surfaceView); mediaController.setEnabled(true); mediaController.show();
            }
        }
    }
    ...
    @Override
    public  int  getBufferPercentage()  {  return  0;  } @Override
    public boolean canPause() { return true; } @Override
    public boolean canSeekBackward() { return true; } @Override
    public boolean canSeekForward() { return true; } @Override
